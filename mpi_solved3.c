...
/*
 BUG1: missing MPI_Init() and MPI_Finalize().
 SOLUTION: add MPI_Init() at the beginning and MPI_Finalize() at the end.
...
int main (int argc, char *argv[])
{
    ...
    MPI_Init(&argc, &argv);   //!BUG1: add MPI initializer
    ...
    MPI_Finalize();   //!BUG1: add MPI terminator
...
double update(int myoffset, int chunk, int myid) {
    int i; 
    double mysum;
    /* Perform addition to each of my array elements and keep mysum */
    mysum = 0;
